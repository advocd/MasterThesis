...
Mit einer Milliarde User im Monat (Stand 2012) bietet Google Maps\footnote{
	Google Maps ist unter der Adresse https://www.google.at/maps/ zu erreichen. Die getätigten Aussagen über die Webseite beziehen sich auf den Stand von Sommer 2016.
}ein kostenloses geografisches Werkzeug mit sehr hoher Marktverbreitung an (\cite{McClendonGoogleMapsBlog} und \cite{McClendonYoutube}). 
...
Bei Airbnb handelt es sich um eine Webseite die sich auf die Vermittlung von Unterkünften spezialisiert hat\footnote{
	Airbnb ist unter der Adresse https://www.airbnb.at zu erreichen. Die getätigten Aussagen über die Webseite beziehen sich auf den Stand von Sommer 2016.
	}. 
