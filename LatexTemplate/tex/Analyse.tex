...
Dabei werden die einzelnen Technologien hin auf ihren Funktionalität im Kontext der folgenden \nameref{Bedarf} untersucht. 
Abschließend wird im Abschnitt \nameref{AuswahlDerTechnologie} aufgezeigt, welches der drei Technologien aus welchen Gründen verwendet werden soll.
...
Dabei ist allerdings zu beachten, das dies nicht unbedingt notwendig für die Realisierung des Prototypen ist da beide Frameworks die \nameref{Bedarf} erfüllen. 
