...
Ein hoher Wert (Bsp.: 5) bedeutet dabei, das dass Anwendungserlebnis von der Testperson positiv in der entsprechenden Kategorie (Effektivität, Effizienz und Zufriedenheit) war und ein niedriger Wert (Bsp.: 1) das es in der Kategorie negativ war.\\
\\
Für die Usability Analyse werden alle Fragen, welche einer Kategorie zu geordnet sind zusammengefasst und summiert. 
\textbf{Beispiel:} \\
Zur Kategorie Effektivität wurden fünf Fragen gestellt. 
Diese Fragen wurden von einer Testperson mit den Werten 4,4,4,4,4 (5x 4) beantwortet, somit ist das Ergebnis (Summe) in dieser Kategorie 20.\\
\\
Für jede Kategorie (Effektivität, Effizienz und Zufriedenheit) werden die drei Grenzen: Min. Grenze, Max. Grenze und 50\% Grenze separat definiert, da sie von der Anzahl der Fragen abhängig sind. 
...
\paragraph{Min. Grenze} Die Min. Grenze 
\paragraph{Max. Grenze}
\paragraph{50\% Grenze} wenn die Ergebnisse (Summen aus den Kategorien) über diesem Wert liegen wird diese Kategorie als positiv gewertet.
Um die 50\% Grenze zu definieren, wird im Vorfeld eine Min- sowie Max Grenze definiert. 
Diese beziehen sich auf die Anzahl der Fragen der jeweiligen Kategorie\footnote
{
	Beispiel: Zur Kategorie Effektivität wurden fünf Fragen gestellt. 
	Jede Frage kann mit einem Wert von 1 bis 5 beantwortet werden, daraus ergibt sich folgende Formel:\\
	Min. Grenze = Anzahl Fragen x 1 Punkt = 5 x 1 = 5 \\
...
Zusätzlich kann die Kategorie Effektivität nur unter der Voraussetzung das   
...
\\
Zu der Kategorie Effektivität wurden im Fragebogen fünf Fragen gestellt welche mit einem Wert von 1 bis 5 beantwortet wurden.
Anhand dieser Ergebnisse wurde die Auswertung \nameref{fig:AuswertungEffektivitaet} (siehe Abb.: \ref{fig:AuswertungEffektivitaet}) erstellt.

Daraus ergibt sich, das der die kleinst mögliche Summe (Min Grenze) fünf Punkten entspricht. 
Des weiteren beträgt somit die maximale Summe (Max Grenze) 25 Punkte.
Anhand dieser beiden Grenzen liegt die 50\% Grenze bei 15 Punkten.\\
\\
...
\caption[Übersicht der Effektivität]{
	Auswertung Effektivität: Zeigt jeweils, nach Gruppen sortiert (siehe: \nameref{Stichproben}) sowie Gesamt (alle Gruppen), die summierten Punkte (min, max und Mittelwert) der Antworten aus dem Fragebogen, welche sich auf die Kategorie Effektivität beziehen.
	}
