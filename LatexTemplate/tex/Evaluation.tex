...
\\
Zu der Kategorie Effektivität wurden im Fragebogen fünf Fragen gestellt woraus sich folgende Grenzen definieren: 
\begin{itemize}
	\item[] Min. Grenze: 5 Punkte
	\item[] Max. Grenze: 25 Punkte
	\item[] 50\% Grenze: 15 Punkte
\end{itemize} 
...
\paragraph{Aufbau des Diagramms:} Dabei sind die Ergebnisse (R\low{Kategorie}) in vier Bereiche aufgeteilt, welche die Ergebnisse anhand der einzelnen Testgruppen gefiltert als auch im Gesamten (über alle Testgruppen) visualisieren.
Jeder Bereich besteht dabei aus den drei Säulen Min. Wert (grüne Säule, links - Abb.: \ref{fig:AuswertungEffektivitaet}), Max. Wert (blaue Säule, mitte - Abb.: \ref{fig:AuswertungEffektivitaet}) und Mittelwert (helle Säule, rechts - Abb.: \ref{fig:AuswertungEffektivitaet}) der jeweiligen Testgruppe. 
Die definierten Grenzen Min. Grenze (schwarze Strich-Punkt Linie (vertikal) - siehe Abb. \ref{fig:AuswertungEffektivitaet}), 50\% Grenze (rote Punkt Linie (vertikal) - siehe Abb. \ref{fig:AuswertungEffektivitaet}) und Max. Grenze (grüne Strich Linie  (vertikal) - siehe Abb. \ref{fig:AuswertungEffektivitaet}) wurden zum Zweck der Auswertung und Orientierung abgebildet.
