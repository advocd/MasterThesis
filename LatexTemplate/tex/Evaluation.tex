...
Dieses Erwartungshaltung ist vermutlich dem Umstand geschuldet das die betroffenen Testpersonen in ihrem geistigen Modell der Funktion . 
Bei der Erstellung des Konzeptes wurde entschieden nur die notwendigen Informationen abzubilden. Aus dieser Motivation heraus wurde der Name des Unternehmens, in beiden Ansichten, als Link gestaltet welcher die Detailansicht aufruft, falls weitere Informationen zu dem entsprechenden Unternehmen gewünscht werden.
Aus gründen der Konsistenz in der grafischen Oberfläche wurde der eigentliche Button, zum hinzufügen, im rechten Bereich der Zeile in der Listenansicht platziert
\footnote{
...
\subsection{Verwendung und Einsatz der Darstellungsformen}
Die Kombination der verschiedenen Ansichten ist von den Testpersonen sehr gut angenohmen wurden.
