...
\\
Folgende Abbildung (Abb.: \ref{fig:ProblemeInterview1} \nameref{fig:ProblemeInterview1}) zeigt die Verteilung der Probleme welche im ersten Interview genant wurden. 
...
\caption[Probleme Interview I]{Übersicht der genanten Probleme in Interview I (Quelle: eigene Ausarbeitung)}
...
\\
Folgende Abbildung (Abb.: \ref{fig:ProblemeInterview2} \nameref{fig:ProblemeInterview2}) zeigt die Verteilung der Probleme welche im zweiten Interview genant wurden. 
Diese sind \nameref{p1}, \nameref{p2}, \nameref{p3}, \nameref{p4}, \nameref{p5} und \nameref{p6} (Siehe Abschnitt \ref{subsubsec:Ergebnisse der Interviews:probleme} \nameref{subsubsec:Ergebnisse der Interviews:probleme} für weitere Informationen).
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{img/Interviews/ProblemeInterview2}
\caption[Probleme in Interview II]{Übersicht der genanten Probleme in Interview II (Quelle: eigene Ausarbeitung)}
...
\caption[Probleme in Interview III]{übersicht der genanten Probleme in Interview III (Quelle: eigene Ausarbeitung)}
...
\subsection*{Verteilte Datenquellen}
\label{p1}
Die Daten sind auf verschiedene Medien und Systeme verteilt. 
Laut den Interviews sind die Datenquellen dabei nicht nur auf verschiedene Softwaresystem verteilt sondern auch auf unterschiedlichsten Medien wie Beispielsweise Taschenkalender (siehe \nameref{anhang:interview1})
Dadurch ist keine direkte Abfrage über die internen Firmendaten möglich. 
Das hat zur Folge das die benötigten Daten für das Filterungsverfahren mühsam, teilweise von Hand, rausgesucht werden müssen.

\subsection*{Datenstrukturen}
\label{p2}
Unzureichende Unterstützung bei kundenspezifischen Daten

\subsection*{Routenverwaltung}
\label{p3}
Keine Möglichkeit Routen zu verwalten

\subsection*{Filterungsverfahren}
\label{p4}
Suboptimale Filterungsverfahren

\subsection*{Export}
\label{p5}
Umständliche Exportieren von Kundendaten

\subsection*{Visualisierung Geodaten}
\label{p6}
